...
func (sq *StatusQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Status, error) {
	...
	if query := sq.withMetadata; query != nil {
		if err := sq.loadMetadata(ctx, query, nodes, nil,
...
func (sq *StatusQuery) loadNamespace(ctx context.Context, query *StatusNamespaceQuery, nodes []*Status, init func(*Status), assign func(*Status, *StatusNamespace)) error {
...
func (sq *StatusQuery) loadMetadata(ctx context.Context, query *MetadataQuery, nodes []*Status, init func(*Status), assign func(*Status, *Metadata)) error {
	ids := make([]gidx.PrefixedID, 0, len(nodes))
	nodeids := make(map[gidx.PrefixedID][]*Status)
	for i := range nodes {
